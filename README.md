...
1.  hw_proc.sh - скрипт эмулирующи выполнение команды "ps ax". Для демонстрации работы просто запустить скрипт из рабочей директории пользователя vagrant, после старта Vagrant-а.
